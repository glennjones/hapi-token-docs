...
function Handlers() {
    ...
    this.mongodbURL = (process.env.MONGOLAB_URI || 'mongodb://127.0.0.1/be-more-hapi');
    this.connection = Mongoose.createConnection(this.mongodbURL);
    this.store = new Store(Mongoose, this.connection);
...
Handlers.prototype = {
    ...
    add: function(request, reply) {
        Maths.add(internals.buildOptions(request), function(error, result) {
    ...
    subtract: function(request, reply) {
        Maths.subtract(internals.buildOptions(request), function(error, result) {
            internals.renderJSON(request, reply, error, { 'equals': parseFloat(result) });
        });
    },
    ...
    divide: function(request, reply) {
        Maths.divide(internals.buildOptions(request), function(error, result) {
            internals.renderJSON(request, reply, error, { 'equals': parseFloat(result) });
        });
    },
    ...
    multiple: function(request, reply) {
        Maths.multiple(internals.buildOptions(request), function(error, result) {
            internals.renderJSON(request, reply, error, { 'equals': parseFloat(result) });
        });
    },
